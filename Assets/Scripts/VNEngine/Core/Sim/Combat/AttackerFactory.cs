...
namespace VNEngine
{
    ...
    public static class AttackerFactory
    {
        ...
        public static Attacker Create(UnitClassDef cls, int threatBase, IRandom rng)
        {
            if (cls == null) throw new ArgumentNullException(nameof(cls));
            if (rng == null) throw new ArgumentNullException(nameof(rng));

            // 호출 순서 고정(결정론 재현): HP, ATK, DEF.
            ...
            return new Attacker(cls.Id, hp, atk, def, cls.CanBeCaptured);
        }
    }
}
