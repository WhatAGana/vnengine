...
namespace VNEngine.Tests
{
    public class AttackerFactoryTests
    {
        ...
        public void SameSeedProducesSameAttacker()
        {
            ...
            var a = AttackerFactory.Create(cls, threatBase: 100, rng: new SeededRandom(42));
            var b = AttackerFactory.Create(cls, threatBase: 100, rng: new SeededRandom(42));
        ...
        public void DeviationStaysWithinPlusMinusFive()
        {
            ...
            for (int i = 0; i < 200; i++)
            {
                var a = AttackerFactory.Create(cls, threatBase: 1000, rng: rng);
        ...
        public void SmallThreatBaseClampsToMinimumOne()
        {
            ...
            for (int i = 0; i < 200; i++)
            {
                var a = AttackerFactory.Create(cls, threatBase: 1, rng: rng);
        ...
        public void ClassProfilePercentagesAreReflectedRelativeToEachOther()
        {
            ...
            var tankA = AttackerFactory.Create(tank, threatBase: 1000, rng: new SeededRandom(1));
            var priestA = AttackerFactory.Create(priest, threatBase: 1000, rng: new SeededRandom(1));
        ...
        public void CanBeCapturedPropagatesFromClassDef()
        {
            ...
            var a = AttackerFactory.Create(captureable, threatBase: 100, rng: new SeededRandom(5));
            var b = AttackerFactory.Create(notCaptureable, threatBase: 100, rng: new SeededRandom(5));
        ...
        public void ClassIdPropagatesFromClassDef()
        {
            ...
            var a = AttackerFactory.Create(cls, threatBase: 100, rng: new SeededRandom(2));
        ...
        public void RngCalledExactlyThreeTimesInHpAtkDefOrder()
        {
            ...
            AttackerFactory.Create(cls, threatBase: 100, rng: recorder);
        ...
        public void NullRngThrows()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => AttackerFactory.Create(cls, threatBase: 100, rng: null));
        }

        [Test]
        public void NullClassDefThrows()
        {
            Assert.Throws<ArgumentNullException>(() => AttackerFactory.Create(null, threatBase: 100, rng: new SeededRandom(1)));
        }
